...
public class StringsActionGroup extends DefaultActionGroup {
    ...
    public AnAction @NotNull [] getChildren(AnActionEvent e) {
        ...
        actions.add(new GetLengthAction("Get length", AllIcons.Gutter.Unique));
        actions.add(new StringSplitAction("Split to multi line", AllIcons.Breakpoints.MultipleBreakpointsMuted));
        actions.add(new StringJoinAction("Join to one line", AllIcons.Breakpoints.MultipleBreakpointsMuted));
        actions.add(new StringWrapQuoteAction("Wrap with quote", AllIcons.Breakpoints.MultipleBreakpointsMuted));
